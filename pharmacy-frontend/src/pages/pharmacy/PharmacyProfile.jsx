      ...
      <div className="card p-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">View and manage your pharmacy account information</p>
          </div>
          {!isEditing && (
            <button
      ...
      <div className="card p-6">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex justify-between py-2 border-b">
            ...
            <span className="font-medium">Pharmacy Staff</span>
          </div>
          <div className="flex justify-between py-2 border-b">
            <span className="text-gray-600">Can Manage Stock</span>
            <span className="font-medium text-green-600">✓ Yes</span>
          </div>
          <div className="flex justify-between py-2 border-b">
            <span className="text-gray-600">Can Process Orders</span>
            <span className="font-medium text-green-600">✓ Yes</span>
          </div>
          <div className="flex justify-between py-2">
            <span className="text-gray-600">Can Manage Invoices</span>
            <span className="font-medium text-green-600">✓ Yes</span>
          </div>
        </div>
      </div>
